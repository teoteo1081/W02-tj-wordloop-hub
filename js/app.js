...
(function (w) {
  ...
  function fwCardPreviewHtml(b) {
    ...
    /* TJ báo bản trước "kỳ, mất chữ" — communication_method là CẢ CÂU
       ...
       cắt. Sau khi gói preview chung hàng icon (còn nhiều chỗ trống dọc,
  ...
  function bind() {
    ...
    var frameworkBtn = w.$("#btn-ai-framework");
    if (frameworkBtn) {
      frameworkBtn.onclick = function () {
        w.$("#modal-framework").hidden = false;
        setTimeout(function () { w.$("#framework-input").focus(); }, 50);
      };
    }
